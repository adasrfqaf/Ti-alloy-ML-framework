"""
Supplementary Code - XGBoost Fine-Tuning with Gaussian Noise Augmentation
...
# ====================== Main Pipeline ======================
print("=" * 100)
print("XGBoost Fine-Tuning with Complete Train/Test Metrics (CV R² Mean ± Std)")
print("=" * 100)
...
# ====================== Results Summary ======================
print("\n\n" + "=" * 120)
print("XGBoost Fine-Tuning Results (Complete Train/Test Metrics with CV R² Mean ± Std)")
print("=" * 120)
...
for sigma in SIGMA_RATIOS:
    ...
    if len(subset) > 0:
        ...
        print(f"σ={sigma:.3f}: Best expansion = {int(best_row['n_copies'])}x")
