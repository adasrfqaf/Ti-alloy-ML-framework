"""
Supplementary Code - Random Forest Fine-Tuning with Gaussian Noise Augmentation (C14 Dataset)
...
# ====================== Main Pipeline ======================
print("=" * 100)
print("Random Forest Fine-Tuning - C14 Dataset (Gaussian Noise Augmentation)")
print("=" * 100)
...
# ====================== Results Summary ======================
print("\n\n" + "=" * 120)
print("Random Forest Performance Comparison (Different Noise Levels × Expansion Factors)")
print("=" * 120)
