"""
Supplementary Code - GBDT Fine-Tuning with Gaussian Noise Augmentation (TiFe Dataset)
...
SIGMA_RATIOS = [0.045, 0.055, 0.05]
EXPANSION_FACTORS = [2, 3, 4, 6, 5]
...
# ====================== Main Pipeline ======================
print("=" * 100)
print("GBDT Fine-Tuning - TiFe Dataset (Gaussian Noise Augmentation)")
print("=" * 100)
...
print("\n" + "=" * 120)
print("GBDT Optimization Complete! No files were saved.")
print("=" * 120)