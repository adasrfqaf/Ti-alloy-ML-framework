"""
Supplementary Code - MLP Fine-Tuning with Gaussian Noise Augmentation (TiFe Dataset)

This script performs fine-tuning for MLP with Gaussian noise augmentation
...
# MLP hyperparameter search space (for small dataset)
PARAM_DIST = {
...
# ====================== Main Pipeline ======================
print("=" * 100)
print("MLP Fine-Tuning - TiFe Dataset (Gaussian Noise Augmentation)")
print("=" * 100)
...
for sigma_ratio in SIGMA_RATIOS:
    for n_copies in EXPANSION_FACTORS:
        ...
        # Standardization (MLP is scale-sensitive)
        scaler = StandardScaler()
        ...
        random_search = RandomizedSearchCV(
            mlp, PARAM_DIST, n_iter=N_ITER, cv=CV_FOLDS,
...
# ====================== Results Summary ======================
print("\n\n" + "=" * 120)
print("MLP Performance Comparison (Different Noise Levels × Expansion Factors)")
print("=" * 120)
...
print("\n" + "=" * 120)
print("MLP Optimization Complete! No files were saved.")
print("=" * 120)