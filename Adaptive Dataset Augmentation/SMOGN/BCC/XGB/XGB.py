"""
Supplementary Code - XGBoost Fine-Tuning with SMOGN Augmentation (C14 Alloy Screening Dataset)
...
if __name__ == "__main__":
    ...
    # 9. Save test set predictions (true vs predicted)
    test_results = pd.DataFrame({
        'true_capacity': y_test.values,   # if y_test is pandas Series; if numpy array, just y_test
        'ours_pred': y_test_pred
    })
    output_path = "test_predictions_BCC.csv"  # 可自定义路径
