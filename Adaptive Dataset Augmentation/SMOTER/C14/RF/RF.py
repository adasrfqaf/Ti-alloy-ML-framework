"""
Supplementary Code for C14 Laves Phase - Random Forest Grid Search Optimization with SMOTER Augmentation

This script performs hyperparameter optimization for Random Forest with SMOTER augmentation
...
print("=" * 60)
print("C14 Laves Phase - Random Forest Grid Search")
print("=" * 60)
...
grid_search = GridSearchCV(
    rf_base, param_grid,
    cv=5, scoring='r2',
    n_jobs=1, verbose=0  # 静默，不输出网格搜索过程
)
...
cv_scores_r2 = cross_val_score(best_rf, X_train_selected, y_train_aug, cv=cv, scoring='r2')
