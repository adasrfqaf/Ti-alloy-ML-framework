"""
GBDT Refined Grid Search for Best Configuration with Strong Regularization (TiFe Dataset)
Fixed: SMOTER 10%, 20 features.
Grid designed to reduce overfitting while maintaining high test R².
...
# ====================== Fixed Configuration ======================
SMOTER_RATIO = 0.10          # 最佳比例
N_FEATURES = 20              # 最佳特征数
K_NEIGHBORS = 5
CV_FOLDS = 5

# ====================== Grid with Strong Regularization ======================
# 基于当前最佳参数，但大幅收紧正则化
PARAM_GRID = {
    'n_estimators': [245],
    'learning_rate': [0.042],
...
# ====================== Main ======================
print("=" * 60)
print("GBDT Refined Grid Search with Strong Regularization")
...
print(f"\nGrid search over {total_combos} combinations (5-fold CV)...")
...
print("\n" + "=" * 60)
print("Grid Search Results with Strong Regularization")
print("=" * 60)
