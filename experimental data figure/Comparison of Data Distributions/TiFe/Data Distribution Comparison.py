# =============================================================================
# TiFe Dataset - Data Augmentation Visualization
...
# ==================== 1. Load data ====================
file_path = r"TiFe_data.csv"   # Adjust path if needed
...
plt.title('TiFe: Target distribution (Original vs SMOGN)', fontsize=24, fontweight='bold', fontfamily='Times New Roman')
...
plt.tight_layout()
plt.savefig('Fig3_TiFe_KDE_SMOGN.png', dpi=600, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig('Fig4_TiFe_PCA_projection.png', dpi=600, bbox_inches='tight')
plt.show()
